...
class Product(models.Model):
    ...
    category=models.ForeignKey(Category,null=True,on_delete=models.CASCADE,related_name='category_products')
    ...
    # need to fix image
    image=models.ImageField(upload_to="products/images/",default='products/default.jpeg')
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        ...
        return f'{self.name} {self.product.image}'
